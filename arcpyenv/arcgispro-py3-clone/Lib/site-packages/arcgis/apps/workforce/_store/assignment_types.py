...
def add_assignment_types(project, assignment_types):
    ...
    if assignment_types:
        ...
        if existing_assignment_types:
            max_code = max([assignment_type.code for assignment_type in existing_assignment_types])
        else:
            max_code = 0
        for assignment_type in assignment_types:
            validate(assignment_type._validate_for_add, assignment_types=existing_assignment_types)
...
def update_assignment_types(project, assignment_types):
    ...
    if assignment_types:
        ...
        existing_assignment_types = coded_values_to_assignment_types(project, coded_values)
        for assignment_type in assignment_types:
            validate(assignment_type._validate_for_update, assignment_types=existing_assignment_types)
