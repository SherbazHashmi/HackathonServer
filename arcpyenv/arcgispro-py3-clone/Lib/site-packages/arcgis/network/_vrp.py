...
default_orders = {
    'fields': [{'alias': 'ObjectID', 'name': 'ObjectID', 'type': 'esriFieldTypeOID'},
               ...
               {'alias': 'TimeWindowStart1', 'name': 'TimeWindowStart1', 'type': 'esriFieldTypeDate', 'length': 8},
               {'alias': 'TimeWindowEnd1', 'name': 'TimeWindowEnd1', 'type': 'esriFieldTypeDate', 'length': 8},
               {'alias': 'TimeWindowStart2', 'name': 'TimeWindowStart2', 'type': 'esriFieldTypeDate', 'length': 8},
               {'alias': 'TimeWindowEnd2', 'name': 'TimeWindowEnd2', 'type': 'esriFieldTypeDate', 'length': 8},
               {'alias': 'MaxViolationTime1', 'name': 'MaxViolationTime1', 'type': 'esriFieldTypeDouble'},
               {'alias': 'MaxViolationTime2', 'name': 'MaxViolationTime2', 'type': 'esriFieldTypeDouble'},
               {'alias': 'InboundArriveTime', 'name': 'InboundArriveTime', 'type': 'esriFieldTypeDate', 'length': 8},
               {'alias': 'OutboundDepartTime', 'name': 'OutboundDepartTime', 'type': 'esriFieldTypeDate', 'length': 8},
               {'alias': 'DeliveryQuantities', 'name': 'DeliveryQuantities', 'type': 'esriFieldTypeString',
                'length': 128},
               {'alias': 'PickupQuantities', 'name': 'PickupQuantities', 'type': 'esriFieldTypeString', 'length': 128},
               {'alias': 'Revenue', 'name': 'Revenue', 'type': 'esriFieldTypeDouble'},
               {'alias': 'SpecialtyNames', 'name': 'SpecialtyNames', 'type': 'esriFieldTypeString', 'length': 128},
               {'alias': 'AssignmentRule', 'name': 'AssignmentRule', 'type': 'esriFieldTypeInteger'},
               {'alias': 'RouteName', 'name': 'RouteName', 'type': 'esriFieldTypeString', 'length': 128},
...
default_depots = {
                                      'fields': [{'alias': 'ObjectID', 'name': 'OBJECTID', 'type': 'esriFieldTypeOID'},
                                                 {'alias': 'Name', 'name': 'Name', 'type': 'esriFieldTypeString',
                                                  'length': 128},
                                                 {'alias': 'TimeWindowStart1', 'name': 'TimeWindowStart1',
                                                  'type': 'esriFieldTypeDate', 'length': 8},
                                                 {'alias': 'TimeWindowEnd1', 'name': 'TimeWindowEnd1',
                                                  'type': 'esriFieldTypeDate', 'length': 8},
                                                 {'alias': 'TimeWindowStart2', 'name': 'TimeWindowStart2',
                                                  'type': 'esriFieldTypeDate', 'length': 8},
                                                 {'alias': 'TimeWindowEnd2', 'name': 'TimeWindowEnd2',
                                                  'type': 'esriFieldTypeDate', 'length': 8},
                                                 {'alias': 'CurbApproach', 'name': 'CurbApproach',
                                                  'type': 'esriFieldTypeInteger'},
                                                 {'alias': 'Bearing', 'name': 'Bearing', 'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'BearingTol', 'name': 'BearingTol',
...
default_routes = {
                                      'fields': [{'alias': 'ObjectID', 'name': 'OBJECTID', 'type': 'esriFieldTypeOID'},
                                                 ...
                                                 {'alias': 'EndDepotName', 'name': 'EndDepotName',
                                                  'type': 'esriFieldTypeString', 'length': 128},
                                                 {'alias': 'StartDepotServiceTime', 'name': 'StartDepotServiceTime',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'EndDepotServiceTime', 'name': 'EndDepotServiceTime',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'EarliestStartTime', 'name': 'EarliestStartTime',
                                                  'type': 'esriFieldTypeDate', 'length': 8},
                                                 {'alias': 'LatestStartTime', 'name': 'LatestStartTime',
                                                  'type': 'esriFieldTypeDate', 'length': 8},
                                                 {'alias': 'ArriveDepartDelay', 'name': 'ArriveDepartDelay',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'Capacities', 'name': 'Capacities',
                                                  'type': 'esriFieldTypeString', 'length': 128},
                                                 {'alias': 'FixedCost', 'name': 'FixedCost',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'CostPerUnitTime', 'name': 'CostPerUnitTime',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'CostPerUnitDistance', 'name': 'CostPerUnitDistance',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'OvertimeStartTime', 'name': 'OvertimeStartTime',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'CostPerUnitOvertime', 'name': 'CostPerUnitOvertime',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'MaxOrderCount', 'name': 'MaxOrderCount',
                                                  'type': 'esriFieldTypeInteger'},
                                                 {'alias': 'MaxTotalTime', 'name': 'MaxTotalTime',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'MaxTotalTravelTime', 'name': 'MaxTotalTravelTime',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'MaxTotalDistance', 'name': 'MaxTotalDistance',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'SpecialtyNames', 'name': 'SpecialtyNames',
                                                  'type': 'esriFieldTypeString', 'length': 128},
...
default_breaks = {
                                      'fields': [{'alias': 'ObjectID', 'name': 'OBJECTID', 'type': 'esriFieldTypeOID'},
                                                 {'alias': 'RouteName', 'name': 'RouteName',
                                                  'type': 'esriFieldTypeString', 'length': 128},
                                                 {'alias': 'Precedence', 'name': 'Precedence',
                                                  'type': 'esriFieldTypeInteger'},
                                                 {'alias': 'ServiceTime', 'name': 'ServiceTime',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'TimeWindowStart', 'name': 'TimeWindowStart',
                                                  'type': 'esriFieldTypeDate', 'length': 8},
                                                 {'alias': 'TimeWindowEnd', 'name': 'TimeWindowEnd',
                                                  'type': 'esriFieldTypeDate', 'length': 8},
                                                 {'alias': 'MaxViolationTime', 'name': 'MaxViolationTime',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'MaxTravelTimeBetweenBreaks',
                                                  'name': 'MaxTravelTimeBetweenBreaks', 'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'MaxCumulWorkTime', 'name': 'MaxCumulWorkTime',
                                                  'type': 'esriFieldTypeDouble'},
...
default_route_zones = {
                                      'fields': [{'alias': 'ObjectID', 'name': 'OBJECTID', 'type': 'esriFieldTypeOID'},
                                                 {'alias': 'RouteName', 'name': 'RouteName',
                                                  'type': 'esriFieldTypeString', 'length': 128},
                                                 {'alias': 'IsHardZone', 'name': 'IsHardZone',
                                                  'type': 'esriFieldTypeInteger'},
...
default_route_renewals = {
                                      'fields': [{'alias': 'ObjectID', 'name': 'OBJECTID', 'type': 'esriFieldTypeOID'},
                                                 {'alias': 'RouteName', 'name': 'RouteName',
                                                  'type': 'esriFieldTypeString', 'length': 128},
                                                 {'alias': 'DepotName', 'name': 'DepotName',
                                                  'type': 'esriFieldTypeString', 'length': 128},
                                                 {'alias': 'ServiceTime', 'name': 'ServiceTime',
                                                  'type': 'esriFieldTypeDouble'},
...
default_order_pairs = {
                                      'fields': [{'alias': 'ObjectID', 'name': 'OBJECTID', 'type': 'esriFieldTypeOID'},
                                                 {'alias': 'FirstOrderName', 'name': 'FirstOrderName',
                                                  'type': 'esriFieldTypeString', 'length': 128},
                                                 {'alias': 'SecondOrderName', 'name': 'SecondOrderName',
                                                  'type': 'esriFieldTypeString', 'length': 128},
                                      ...
                                      'fields': [{'alias': 'ObjectID', 'name': 'OBJECTID', 'type': 'esriFieldTypeOID'},
                                                 {'alias': 'Name', 'name': 'Name', 'type': 'esriFieldTypeString',
                                                  'length': 128}, {'alias': 'BarrierType', 'name': 'BarrierType',
                                                                   'type': 'esriFieldTypeInteger'},
                                                 {'alias': 'Scaled_Time', 'name': 'Scaled_Time',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'Scaled_Distance', 'name': 'Scaled_Distance',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'Shape_Length', 'name': 'Shape_Length',
                                                  'type': 'esriFieldTypeDouble'},
                                                 {'alias': 'Shape_Area', 'name': 'Shape_Area',
...
SolveVehicleRoutingProblem tool solves a vehicle routing problem (VRP) to find the best routes for a fleet of vehicles.
...
Parameters:
   ...
   orders: Orders (FeatureSet). Required parameter.  Specify one or more orders (up to 2,000). These are the locations
    that the routes of the vehicle routing problem (VRP) analysis
            should visit. An order can represent a delivery (for example,
           ...
           Name:  The name of the order. The name must be unique. If the
           ...
           TimeWindowStart1: The beginning
            time of the first time window for the
            network location. This field can contain a null value; a null value
            indicates no beginning time.

            A time window only states when a vehicle can arrive
            ...
            The time window fields can contain a time-only value or a
           ...
           TimeWindowStart2: The beginning time of the second time window for the
            ...
            If both time windows are nonnull, they can't
           ...
           Defines when the item to be delivered to the order will be ready at the starting depot. The order can be assigned to a route only if the inbound arrive time precedes the route's latest start time value; this way, the route cannot leave the depot before the item is ready to be loaded onto it. This field can help model scenarios involving inbound-wave transshipments. For example, a job at an order requires special materials that are not currently available at the depot. The materials are being shipped from another location and will arrive  at the depot at 11:00 a.m. To ensure a route that leaves before the shipment arrives isn't assigned to the order, the order's inbound arrive time is set to 11:00 a.m. The special materials arrive at 11:00 a.m., they are loaded onto the vehicle, and the vehicle departs from the depot to visit its assigned orders.
            Notes: The route's start time, which includes service times, must occur after the inbound arrive time. If a route begins before an order's inbound arrive time, the order cannot be assigned to the route. The assignment is invalid even if the route has a start-depot service time that lasts until after the inbound arrive time.
                  ...
                  the date specified by the Default Date parameter.  The default date is ignored, however, when any time field in the Depots, Routes, Orders, or Breaks includes a date with the time. In that case, specify all such fields with a date and time (for example, 7/11/2015 11:00 AM).
                 The VRP solver honors InboundArriveTime regardless of the DeliveryQuantities value. If an outbound depart time is also specified, its time value must occur after the inbound arrive time. OutboundDepartTime:
           Defines when the item to be picked up at the order must arrive at the ending depot. The order can be assigned to a route only if the route can visit the order and reach its end depot before the specified outbound depart time. This field can help model scenarios involving outbound-wave transshipments. For instance, a shipping company sends out delivery trucks to pick up packages from orders and bring them into a depot where they are forwarded on to other facilities, en route to their final destination.  At 3:00 p.m. every day, a semitrailer stops at the depot to pick up the high-priority packages and take them directly to a central processing station. To avoid delaying the high-priority packages until the next day's 3:00 p.m. trip, the shipping company tries to have delivery trucks pick up the high-priority packages from orders and bring them to the depot before the 3:00 p.m. deadline. This is done by setting  the outbound depart time to 3:00 p.m.
            Notes: The route's end time, including service times, must occur before the outbound depart time. If a route reaches a depot but doesn't complete its end-depot service time prior to the order's outbound depart time, the order cannot be assigned to the route.
                  This time field can contain a time-only value or a date and
                  time value. If a
                  time-only value is set (for example, 11:00 AM), the date is assumed to be
                  the date specified by the Default Date parameter.  The default date is ignored, however, when any time field in Depots, Routes, Orders, or Breaks includes a date with the time. In that case, specify all such fields with a date and time (for example, 7/11/2015 11:00 AM).
                 The VRP solver honors OutboundDepartTime regardless of the PickupQuantities value. If an inbound arrive time is also specified, its time value must occur before the  outbound depart time. DeliveryQuantities: The size of the delivery. You can specify size in
            any dimension you want, such as weight, volume, or quantity. You
           ...
           AssignmentRule: This field specifies the rule for assigning the order to a
            ...
            This field can't contain a null
            value.
           CurbApproach:  Specifies the direction a vehicle may arrive at and depart
            ...
            After a solve operation, if the order is routed, the
            RouteName field contains the name of the route to which the order is
            assigned.
           Sequence: This indicates the sequence of the order on its
            assigned route.
   ...
   depots: Depots (FeatureSet). Required parameter.  Specify one or more depots for the given vehicle routing problem. A depot
            ...
            arrive at a depot outside of this time window.
           When specifying the orders, you can set properties for each one, such as its name or service time, by using attributes. The orders can be specified with the following attributes: ObjectID: The system-managed ID field.
           Name: The name of the depot. The StartDepotName and EndDepotName
            fields of the Routes record set reference the names you specify
            here. It is also referenced by the Route Renewals record set, when
            used.

            Depot names are case insensitive and have to be nonempty
            and unique.
           TimeWindowStart1: The beginning time of the first time window for the
            network location. This field can contain a null value; a null value
            indicates no beginning time.

            Time window fields can contain a time-only value or a date
           ...
           CurbApproach:  Specifies the direction a vehicle may arrive at and depart
            ...
            For more information, see the Bearing and Bearing Tolerance Help topic (http://links.esri.com/bearing-and-bearing-tolerance). BearingTol: The bearing tolerance value creates a range of acceptable
   ...
   routes: Routes (FeatureSet). Required parameter.  Specify one or more routes (up to 100). A route specifies vehicle and driver
            characteristics; after solving, it also represents the path between
            depots and orders.

            A route can have start and end depot service times, a
            fixed or flexible starting time, time-based operating costs,
            distance-based operating costs, multiple capacities, various
            constraints on a driver's workday, and so on. When specifying the routes, you can set properties for each one by using attributes. The routes can be specified with the following attributes:
           Name: The name of the route. The name must be
            unique.

            The tool  generates a unique name at solve time if
           ...
           EndDepotName: The name of the ending depot for the route. This field is
            a foreign key to the Name field in the Depots class.
           StartDepotServiceTime: The service time at the starting depot. This can be used
            to model the time spent for loading the vehicle. This field can
           ...
           EndDepotServiceTime: The service time at the ending depot. This can be used to
            model the time spent for unloading the vehicle. This field can
            contain a null value; a null value indicates zero service
            time.
           ...
           ArriveDepartDelay: This field stores the amount of travel time needed to
            ...
            The VRP solver only performs a simple Boolean test to
   ...
   breaks: Breaks (FeatureSet). Required parameter.  These are the rest periods, or breaks, for the routes in a given
            ...
            time.
           When specifying the breaks, you can set properties for each one, such as its name or service time, by using attributes. The orders can be specified with the following attributes: ObjectID: The system-managed ID field.
           ...
           ServiceTime: The duration of the break. This field can contain null
            ...
            The unit for this field value is specified by the time_units parameter. TimeWindowStart: The starting time of the break's time window.
            ...
            When solving a problem that spans multiple time zones, each break's time-window values refer to the time zone in which the associated route, as specified by the RouteName field,  is located. TimeWindowEnd: The ending time of the break's time window.
           ...
           MaxViolationTime: This field specifies the maximum allowable violation time
            ...
            The unit for this field value is specified by the time_units parameter. MaxCumulWorkTime:

            The maximum amount of work time that can be accumulated
   ...
   time_units: Time Units (str). Required parameter.  The time units for all time-based field values in the
            ...
            Note that output time-based fields use the same units
            specified by this parameter.
      Choice list:['Seconds', 'Minutes', 'Hours', 'Days']

   distance_units: Distance Units (str). Required parameter.  The distance units for all distance-based field values in
   ...
   default_date: Default Date (datetime). Optional parameter.  The default date for time field values that specify a time
   ...
   route_zones: Route Zones (FeatureSet). Optional parameter.  Delineates work territories for given routes. A route zone
            ...
            are some examples of when route zones may be useful:
               ...
               When specifying the route zones, you need to set properties for each one, such as its associated route, by using attributes. The route zones can be specified with the following attributes: ObjectID: The system-managed ID field.
   ...
   order_pairs: Order Pairs (FeatureSet). Optional parameter.  This parameter pairs pickup and delivery orders so they are serviced by
            the same route.
           ...
           When specifying the order pairs, you need to set properties for each one, such as the names of the two orders, by using attributes. The order pairs can be specified with the following attributes: ObjectID: The system-managed ID field.
           ...
           MaxTransitTime: The maximum transit time for the pair. The transit time is
            ...
            By assigning an importance level for the excess_transit_factor parameter, you are in effect choosing one of these
            three approaches. Regardless of the importance level, the solver
            will always return an error if the MaxTransitTime value is
            surpassed.

   excess_transit_factor: Excess Transit Factor (str). Optional parameter.  Rates the importance of reducing excess transit time of
   ...
   restrictions: Restrictions (str). Optional parameter.  Specify which restrictions should be honored by the tool when finding the best routes.  The value you provide for this parameter is ignored unless Travel Mode is set to Custom, which is the default value.
            A restriction represents a driving
   ...
   route_line_simplification_tolerance: Route Line Simplification Tolerance (LinearUnit). Optional parameter.  Specify by how much you want to simplify the geometry of the output lines for routes and directions. The value you provide for this parameter is ignored unless Travel Mode is set to Custom, which is the default value. The tool also ignores this parameter if the populate_route_lines parameter is unchecked (False).
